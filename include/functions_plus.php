...
function ipv6statue($type = 'IPV6', $refresh = false)
{//1IPV6,2NETWORK
...
<head>
    ...
    <base href="<?
    echo get_protocol_prefix() . $BASEURL . $_SERVER['SCRIPT_NAME'] . ($_SERVER['QUERY_STRING'] ? "?" . htmlspecialchars($_SERVER['QUERY_STRING']) : "") ?>"/>
    <?php
...
<tr>
    <td class="clear">
        ...
        if ($logo_main == "") {
            ...
            ?>
            <div class="logo_img"><img src="<?php echo $logo_main ?>" alt="<?php echo htmlspecialchars($SITENAME) ?>"
...
<tr>
    <td id="nav_block" class="text" align="center">
        <div class="stickers png"></div>
        <?php if (!$CURUSER) { ?>
            <a href="login.php"><font class="big"><b><?php echo $lang_functions['text_login'] ?></b></font>
            </a><?php /* / <a href="signup.php"><font class="big"><b><?php echo $lang_functions['text_signup'] ?></b></font></a>*/ ?>
            <?php
...
*/
                    ...
                    <table width="100%" cellspacing="0" cellpadding="0" border="0">
                        <tr>
                            <td class="bottom" align="left"><span
                                        class="medium"><?php echo $lang_functions['text_welcome_back'] ?>, <?php echo get_username($CURUSER['id']) ?>  [<a
                                            href="logout.php"
                                            title="且退出在其他电脑上的登录"><?php echo $lang_functions['text_logout'] ?></a>] [<a
                                            href="usercp.php"><?php echo $lang_functions['text_user_cp2'] ?></a>] <?php if (get_user_class() >= UC_UPLOADER) { ?> [
                                        <a href="staffpanel.php"><?php echo $lang_functions['text_staff_panel'] ?></a>] <?php }
                                    if (get_user_class() >= UC_SYSOP) { ?> [<a
    ...
    ?>
		<br/>
		<a href="mybonus.php"><font
                    class='color_bonus'><?php echo $lang_functions['text_bonus'] ?></font><?php echo number_format($CURUSER['seedbonus'], 1) ?></a>
		<a href="invite.php"><font
                    class='color_invite'>&nbsp;<?php echo $lang_functions['text_invite'] ?></font><?php echo $invite_have; ?></a><a
                                            href="myhr.php"><font
                                                class='color_bonus'>&nbsp;&nbsp;H&amp;R:</font><?php echo($hr_have) ?></a>
	...
	<a href="getusertorrentlist.php?type=seeding"><img class="arrowup" alt="Torrents seeding"
                                                       title="<?php echo $lang_functions['title_torrents_seeding'] ?>"
                                                       src="pic/trans.gif"/><?php echo $activeseed ?></a>&nbsp;&nbsp;<a
                                            href="getusertorrentlist.php?type=leeching"><img class="arrowdown"
                                                                                             alt="Torrents leeching"
                                                                                             title="<?php echo $lang_functions['title_torrents_leeching'] ?>"
                                                                                             src="pic/trans.gif"/><?php echo $activeleech ?></a>&nbsp;&nbsp;
...
<div style=\"display: none;\" id=\"curtain\" class=\"curtain\" onclick=\"Return();\" onmousewheel=\"return false;\" ></div>");
            ...
            <!--[if IE]>
            <script type="text/javascript" src="javascript/letskillie6.zh_CN.js"></script><![endif]-->
            <!--[if (gt IE 6)|!(IE)]><!-->
...
//print $Cache->get_value('last_browse_'.$variant.'_'.$CURUSER['id']);
            ...
            <tr>
                ...
                <td class="colhead" rowspan="2"><a
                            href="?<?php echo $oldlink ?>sort=1&amp;type=<?php echo $link[1] ?>"><?php echo $lang_functions['col_name'] ?></a><a
                            href="?<?php echo $oldlink ?>sort=11&amp;type=<?php echo $link[11] ?>">[评分]</a></td>
                <?php
                ...
                <td class="colhead" rowspan="2"><a href="?<?php echo $oldlink ?>sort=7&amp;type=<?php echo $link[7] ?>"><img
                                class="seeders" src="pic/trans.gif" alt="seeders"
                                title="<?php echo $lang_functions['title_number_of_seeders'] ?>"/></a></td>
                <td class="colhead" rowspan="2"><a href="?<?php echo $oldlink ?>sort=8&amp;type=<?php echo $link[8] ?>"><img
                                class="leechers" src="pic/trans.gif" alt="leechers"
                                title="<?php echo $lang_functions['title_number_of_leechers'] ?>"/></a></td>
                <td class="colhead" rowspan="2"><a href="?<?php echo $oldlink ?>sort=6&amp;type=<?php echo $link[6] ?>"><img
                                class="snatched" src="pic/trans.gif" alt="snatched"
                                title="<?php echo $lang_functions['title_number_of_snatched'] ?>"/></a></td>
                <td class="colhead" rowspan="2"><a
                            href="?<?php echo $oldlink ?>sort=10&amp;type=<?php echo $link[10] ?>"><img
                                class="unsnatched" src="pic/trans.gif" alt="unsnatched"
                                title="未<?php echo $lang_functions['title_number_of_snatched'] ?>"/></a></td>
                <?php
                ...
                <td class="colhead" COLSPAN="<?php ECHO $COLSPANowner ?>"><a
                            href="?<?php echo $oldlink ?>sort=9&amp;type=<?php echo $link[9] ?>"><?php echo $lang_functions['col_uploader'] ?></a>
                </td>
                <?php
                if (get_user_class() >= $torrentmanage_class) { ?>
            ...
            <tr>
                ...
                <?php
                if ($CURUSER['showcomnum'] != 'no') { ?>
                    <td class="colhead"><a href="?<?php echo $oldlink ?>sort=3&amp;type=<?php echo $link[3] ?>"><img
                                    class="comments" src="pic/trans.gif" alt="comments"
                                    title="<?php echo $lang_functions['title_number_of_comments'] ?>"/></a></td>
                <?php } ?>


                <td class="colhead"><a href="?<?php echo $oldlink ?>sort=4&amp;type=<?php echo $link[4] ?>"><img
                                class="time" src="pic/trans.gif" alt="time"
                                title="<?php echo($CURUSER['timetype'] != 'timealive' ? $lang_functions['title_time_added'] : $lang_functions['title_time_alive']) ?>"/></a>
                </td>
                <td class="colhead"><a href="?<?php echo $oldlink ?>sort=5&amp;type=<?php echo $link[5] ?>"><img
		...
		if($count_dissmall_descr > $max_lenght_of_small_descr)
		{
			$dissmall_descr=mb_strcut($dissmall_descr, 0, $max_lenght_of_small_descr+20,"UTF-8") . "..";
                ...
                switch ($resseedleech[$id]) {
                    case 'seeder'        :
                        $seedingstyle = " style='background-color: Green;' title='做种中'";
                        break;
                    case 'leecher'        :
                        $leechingstyle = " style='background-color: Red;' title='下载中'";
                        break;
                    case 'snatched'    :
                        $snatchedstyle = " style='background-color: Green;' title='已完成'";
                        break;
                    case 'unsnatched'    :
                        $unsnatchedstyle = " style='background-color: Red;' title='未完成'";
                        break;
                }
            ...
            if (get_user_class() >= $torrentmanage_class) { ?>
                <tr>
                    <td class='colhead' style='padding: 0px'><input type="submit" name="deletetorrent"
                                                                    onclick='return confirm("\n确认删除种子吗?");' value="删除">
                    </td>
                    <td class='colhead' style='padding: 0px' align='right' colspan='6'>

                        <?
                        if ($torrentmanagephp) { ?><select name="sel_banstate">
                            <option selected="selected" value="0">普通</option>
                            <option value="1">禁止</option>
                        </select>
                            <input type="submit" name="bannedtorrent" value="禁止">

                            <select name="sel_posstate">
                                <option selected="selected" value="0">普通</option>
                                <option value="1">置顶</option>
                            </select><input type="submit" name="posstatetorrent" value="位置">

                            <select name="sel_recmovie">
                                <option selected="selected" value="0">普通</option>
                            ...
                            <select name="sel_spstate">
                                <option value="1">普通</option>
                                <option value="2">免费</option>
                                <option value="3">2X</option>
                                <option value="4">2X免费</option>
                                <option value="5">50%</option>
                                <option value="6">2X 50%</option>
                                <option value="7">30%</option>
                            </select>
                            <select name="promotion_time_type">
                                <option selected="selected" value="0">全局</option>
                                <option value="1">永久</option>
                                <option value="2">直到</option>
                            </select>
                            <input type="text" style="width: 70px" name="promotionuntil" value="<?
                            echo date("Y-m-d", TIMENOW) ?>"/>
                            <input type="submit" name="promotiontorrent" value="促销"><input type="submit"
                                                                                           name="torrentlowquality"
                                                                                           value="不规范">
                        <?
                        } ?>
                    </td>
...
//	print("<p align=\"center\"> ".$lang_functions['text_promoted_torrents_note']."</p>\n");
        ...
        <table class="torrents" cellspacing="0" cellpadding="5" width="100%">
            <tr>
                ...
                <td class="colhead"><img class="seeders" src="pic/trans.gif" alt="seeders"
                                         title="<?php echo $lang_functions['title_number_of_seeders'] ?>"/></td>
                <td class="colhead" rowspan="2"><img class="snatched" src="pic/trans.gif" alt="snatched"
            ...
            <tr>
                <td class="colhead"><img class="leechers" src="pic/trans.gif" alt="leechers"
                                         title="<?php echo $lang_functions['title_number_of_leechers'] ?>"/></td>


                <td class="colhead"><img class="time" src="pic/trans.gif" alt="time"
                                         title="<?php echo($CURUSER['timetype'] != 'timealive' ? $lang_functions['title_time_added'] : $lang_functions['title_time_alive']) ?>"/>
                </td>
                <td class="colhead"><img class="size" src="pic/trans.gif" alt="size"
                                         title="<?php echo $lang_functions['title_size'] ?>"/></td>
...
//<tr><td class=\"clear\" colspan=\"2\"><strong><font color=\"DarkRed\">".$lang_functions['text_starring'].": </font></strong>".$casts."</td></tr>
            ...
            <script type="text/javascript">userAutoTips({id: 'qrbody'});
                $(window).bind('scroll resize', function (e) {
                    userAutoTips({id: 'qrbody'})
                })</script>
...
function userccss()
{
	...
	#ad_header{background:url(usercss/festival/goodman.gif) no-repeat;}</style>";
        $Advertisement->adrow['header'][0] = "<img src='usercss/festival/goodmanlogo.jpg'>";
    }
...
function imdbupdatefunction($url, $urltype)
{
    ...
    elseif (!$movie->cachestate()) {
        write_log("AUTO_IMDBUPDATE_ERROR_" . $url, 'file');
        $imdbupdatefail++;
        set_cachetimestamp_url($url, 1);
    }
    return false;
}
...
function imdbdoubanautoupdate()
{
    ...
    if ($time < 19) {
        $Cache->cache_value('imdbdoubanautoupdate_continue', 'notmore', 3600 * 24);
